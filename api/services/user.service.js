...
async function addUser(data){
    ...
    try {
        ...
        const result = await db.query('INSERT INTO users (id,name,login,password,email,droit,session,type,nom_photo,description) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *',
            [uuidv4(),data.name,data.login,hashedpassword,data.email,data.droit,data.session,data.nom_photo,data.description])
