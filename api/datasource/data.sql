...
INSERT INTO goodies (id, owner_id, name, price, quantity)
VALUES (1, 'bb4b684c-0c67-4d19-ac21-b225b3e5c018', 'T-shirt', 20, 37),
...
INSERT INTO colors (id, label)
VALUES (1, 'Rouge'),
       (2, 'Bleu'),
       (3, 'Vert'),
       (4, 'Noir'),
       (5, 'Blanc');
INSERT INTO goodies_sizes
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
...
INSERT INTO goodies_colors
VALUES (1, 1),
       (1, 2),
       (2, 3),
       (3, 4),
       (4, 5);
INSERT INTO baskets (id, user_id, date, state)
VALUES ('0f8fad5b-d9cb-469f-a165-70867728950e', 'c38acd4c-d6fc-4a19-bd24-98a7c18fa414', '2025-03-18', 'wait');

INSERT INTO basket_items
VALUES ('0f8fad5b-d9cb-469f-a165-70867728950e', 1, 2, 3, 1);
INSERT INTO ticket_prices (id, name, price)
VALUES ('93b0592a-922d-4b39-9227-b5f7d84c95ff', 'adult', 11),
       ('0936df09-1754-448f-8b09-f6c794c6b251', 'student', 9),
       ('9e671b84-9b15-4543-bc2b-bf7892e0247d', 'child', 5);

INSERT INTO tickets (id, user_id, date_from, date_to, price_id)
VALUES ('4c3bfa40-79f0-4f27-9af0-8bc4f606e0c4', 'a2b1c8c4-2e53-4c37-a4de-3c4fc35b18fa', '2023-05-02',
        '2023-05-02 23:59:59', '93b0592a-922d-4b39-9227-b5f7d84c95ff');
INSERT INTO stand_types (id, type)
VALUES (1, 'cinema'),
       (2, 'autograph');

INSERT INTO stands (id, name, x, y, width, height, type_id, owner_id)
VALUES (1, 'cinema 1', 25, 32, 481, 620, 1, 'f68ab44a-557b-4d44-b1df-a38f894c2dca'),
...
VALUES ('6f207e95-5400-471f-a933-d01d817b0608', 'Killers of the Flower Moon', 'bb4b684c-0c67-4d19-ac21-b225b3e5c018',
        '2023-10-20', 206, 'Une sombre histoire de meurtres', 'killers_moon.jpg'),
       ('6cec5c18-d60b-4372-916a-482bb4facaa0', 'Oppenheimer', 'f68ab44a-557b-4d44-b1df-a38f894c2dca', '2023-07-21',
        180, 'Le père de la bombe atomique', 'oppenheimer.jpg');
INSERT INTO projections (id, stand_id, film_id, date)
VALUES (1, 1, '6f207e95-5400-471f-a933-d01d817b0608', '2025-12-23 14:00:00');

INSERT INTO reservations (id, user_id, date, stand_id, type)
VALUES (1, 'c38acd4c-d6fc-4a19-bd24-98a7c18fa414', '2025-12-23 14:00:00', 1, 'film');

INSERT INTO film_reservations
VALUES (1, 1);
